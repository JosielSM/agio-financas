...
create table if not exists public.clients (
  id uuid primary key,
  -- Texto aceita tanto UUID do Supabase Auth quanto UID do Firebase Auth.
...
-- Exclui todos os dados do próprio usuário em uma única transação.
-- SECURITY INVOKER mantém as políticas RLS ativas durante toda a operação.
